...
import { Eye, EyeOff, ArrowRight, Github, Linkedin, Shield, Mail, Check, Phone } from "lucide-react";
...
export const Login = () => {
  ...
  const mfaMethods = [
    { id: "authenticator", label: "Authenticator App", icon: Phone, description: "Use your authenticator app" },
