export const StatsSection = () => {
  return (
    <section className="relative overflow-hidden py-12 sm:py-20 bg-gradient-to-br from-emerald-900 via-teal-800 to-green-900">
      ...
      <div className="absolute left-0 top-0 w-full sm:w-1/2 h-56 sm:h-full">
        <img
      ...
      {/* Overlay card */}
      <div className="absolute left-1/2 -translate-x-1/2 bottom-4 sm:left-8 sm:translate-x-0 sm:bottom-8 bg-white/95 backdrop-blur-sm text-gray-900 p-3 sm:p-8 rounded-xl sm:rounded-2xl w-11/12 max-w-xs sm:max-w-sm shadow-2xl">
      ...
      <div className="relative z-10 container mx-auto px-2 sm:px-6">
        <div className="flex flex-col sm:flex-row justify-end">
          <div className="w-full sm:w-2/5 space-y-6 mt-64 sm:mt-0">
            <div className="text-center sm:text-right">
              ...
              <p className="text-sm sm:text-lg text-emerald-100 mb-5 sm:mb-8 max-w-full sm:max-w-lg mx-auto sm:ml-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-3 sm:p-6 text-center sm:text-right">
                <p className="text-xs sm:text-sm font-semibold text-emerald-300 mb-1 sm:mb-2">Global Communities</p>
                <p className="text-2xl sm:text-5xl font-bold text-white mb-1 sm:mb-2">150+</p>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-3 sm:p-6 text-center sm:text-right">
                ...
                <p className="text-2xl sm:text-5xl font-bold text-white mb-1 sm:mb-2">75+</p>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-3 sm:p-6 text-center sm:text-right">
                ...
                <p className="text-2xl sm:text-5xl font-bold text-white mb-1 sm:mb-2">2.5M</p>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-3 sm:p-6 text-center sm:text-right">
                ...
                <p className="text-2xl sm:text-5xl font-bold text-white mb-1 sm:mb-2">50M+</p>
