                ...
                <div className="container mx-auto px-4">
                    <div className="flex h-14 items-center justify-between">
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <Button variant="ghost" onClick={() => setShowProfileSidebar(true)} className="text-gray-900 hover:bg-white/10 hover:text-gray-900 hover:scale-105 transition-all duration-300 text-sm px-2 lg:px-3 py-2 rounded-lg flex items-center space-x-2">
                            ...
                            <div className="flex-1 overflow-y-auto p-6 space-y-6">
                                <div>
                                    ...
                                    <nav className="space-y-1">
                                        <Link to="/settings/profile" className="flex items-center p-2 rounded-md hover:bg-gray-100 transition-colors">
                                            <User className="w-5 h-5 mr-3 text-gray-600" />
                                            <span className="text-gray-700 font-medium">Profile Settings</span>
                                        </Link>
                                        <Link to="/settings/security" className="flex items-center p-2 rounded-md hover:bg-gray-100 transition-colors">
                                            <Lock className="w-5 h-5 mr-3 text-gray-600" />
                                            <span className="text-gray-700 font-medium">Security</span>
                                        </Link>
                                        <Link to="/settings/notifications" className="flex items-center p-2 rounded-md hover:bg-gray-100 transition-colors">
                                ...
                                <div>
                                    ...
                                    <nav className="space-y-1">
                                        <Link to="/settings/theme" className="flex items-center p-2 rounded-md hover:bg-gray-100 transition-colors">
                                            <Palette className="w-5 h-5 mr-3 text-gray-600" />
                                            <span className="text-gray-700 font-medium">Theme & Appearance</span>
                                        </Link>
                                        <Link to="/settings/language" className="flex items-center p-2 rounded-md hover:bg-gray-100 transition-colors">
                                ...
                                <div className="border-t pt-4">
                                    ...
                                    <nav className="space-y-1">
                                        <Link to="/settings/privacy" className="flex items-center p-2 rounded-md hover:bg-gray-100 transition-colors">
                                            <Shield className="w-5 h-5 mr-3 text-gray-600" />
                                            <span className="text-gray-700 font-medium">Privacy</span>
                                        </Link>
                                        <Link to="/settings/data" className="flex items-center p-2 rounded-md hover:bg-gray-100 transition-colors">
                        ...
                        {notifications.length === 0 ? (
                            ...
                            <div className="divide-y divide-slate-100">
                                {notifications.map((notification) => (
                                    <div
                                        key={notification.id}
                                        className={`p-4 hover:bg-slate-50 transition-colors cursor-pointer ${notification.unread ? "bg-blue-50/50 border-l-4 border-l-blue-400" : ""
                                            }`}
                                        onClick={() => handleNotificationClick(notification.id)}
                                    >
                            ...
                            <div className="divide-y divide-slate-100">
                                {messages.map((message) => (
                                    <div key={message.id} className="relative">
                                        <div
                                            className={`p-4 hover:bg-slate-50 transition-colors cursor-pointer ${message.unread ? "bg-green-50/50 border-l-4 border-l-green-400" : ""
                                            ...
                                            <div className="border-t bg-white shadow-inner">
                                                <div className="max-h-64 overflow-y-auto p-3 space-y-2">
                                                    {mockChatMessages[message.conversationId]?.map((chatMsg) => (
                                                        ...
                                                        >
                                                            <div
                                                                className={`max-w-[80%] p-2 rounded-lg text-sm ${chatMsg.isOwn
