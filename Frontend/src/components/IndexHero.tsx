...
const OPTIONS: Option[] = [
  {
    id: 1,
    imageUrl:
      "https://amogh-assets.s3.ap-south-1.amazonaws.com/content/photo-1503676260728-1c00da094a0b_11zon.jpg", // student studying
    label: "Students",
  ...
  },
  {
    id: 2,
    imageUrl:
      "https://amogh-assets.s3.ap-south-1.amazonaws.com/content/photo-1531746790731-6c087fecd65a_11zon.jpg", // scientist in lab
    label: "PhD Holders",
  ...
  },
  {
    id: 3,
    imageUrl:
      "https://amogh-assets.s3.ap-south-1.amazonaws.com/content/photo-1519389950473-47ba0277781c_11zon+(1).jpg", // professor lecturing
    label: "Professors",
  ...
  },
  {
    id: 4,
    imageUrl:
      "https://amogh-assets.s3.ap-south-1.amazonaws.com/content/photo-1556761175-4b46a572b786_11zon.jpg", // business meeting
    label: "Business",
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 lg:pr-12">
            <div className="space-y-6">
              <h1 className="text-lg sm:text-4xl font-bold text-gray-900 leading-tight mobile-text-2xl">
