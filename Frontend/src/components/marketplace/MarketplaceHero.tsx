...
export const MarketplaceHero = ({ searchQuery, onSearchChange }: MarketplaceHeroProps) => {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-4xl font-extrabold mb-4 sm:mb-6 tracking-tight leading-tight drop-shadow-sm bg-gradient-to-r from-blue-700 via-indigo-600 to-blue-400 bg-clip-text text-transparent">
          Empowering Innovation, Globally
        </h1>
        
        {!isMobile && (
          <p className="text-base mb-6 sm:mb-8 max-w-2xl mx-auto text-slate-700 font-medium leading-relaxed">
