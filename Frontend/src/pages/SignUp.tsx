  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="w-1/2 bg-white flex items-center justify-center p-8">
        ...
        {currentStep > 1 && (
          <button
            ...
            className="absolute top-6 left-6 flex items-center space-x-2 text-gray-600 hover:text-blue-600 transition-colors z-10 bg-white/80 rounded-full px-3 py-1 shadow-md"
            aria-label="Go back"
            type="button"
          >
      ...
      <div className="w-1/2 bg-gradient-to-br from-purple-400 to-slate-400 flex flex-col p-8 relative overflow-hidden">
        ...
        {/* Benefits sidebar */}
        <div className="mb-20 flex-1 flex items-center justify-center">
          {currentUserType && (
